 ...
 * @author concept
 */
public class cannyDetectorFrame extends javax.swing.JFrame {

    /**
     * Creates new form cannyDetectorFrame
     */
    public cannyDetectorFrame() {
        initComponents();
         load();
        tab();
    }
    ...
    private void initComponents() {
        ...
        jLabel1.setText("CANNY EDGE DETECTOR");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        File output=new File("E:\\Image Processing\\Edged\\simple\\"+jTextField2.getText()+".jpg");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(cannyDetectorFrame.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new cannyDetectorFrame().setVisible(true);
            }
        });
    }
